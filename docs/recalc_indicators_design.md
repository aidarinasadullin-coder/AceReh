...
**Версия:** 1.1  
**Дата:** 2026-03-25  
**На основе:** [brandbook-2026-application.md](./design/brandbook-2026-application.md)  
...
### 1.3 Соответствие брендбуку REHAU 2026

| Параметр | Значение по брендбуку 2026 | Применение в индикаторах |
|----------|---------------------------|--------------------------|
| **Цвета** | Active Red `#E50040`, Smart Green `#4FC7B5` | Бейджи, статусы |
