...
*   **Лучистый тепловой поток ($Q_{изл}$, справочно):**  
    ...
    где $\varepsilon = 0.055$ — коэффициент излучения поверхности, $\sigma = 5.77 \times 10^{-8}$ — постоянная Стефана-Больцмана, $T_{пов} = 273 + t_П = 278$ K.  
...
*(λE = 1.5 — теплопроводность слоя замоноличивания трубы (Бетон плотный, id=5), см. Шаг 2)*
