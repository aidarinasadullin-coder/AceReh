...
namespace SnowMeltingCalculator.Services.Hydraulics
{
    ...
    public class GlycolDataService : IGlycolDataService
    {
        ...
        /// (сетка температур -34.4…98.9, шаг ~5.6). NaN — нет данных в каноне
        /// </summary>
        ...
        private static double[,] DefaultEthyleneSpecificHeatValues()
        {
            ...
            {
                // conc: 10%
                { double.NaN, double.NaN, 3.78, 4.36, 5.0, 5.65, 6.29, 6.93, 7.58 },
                // conc: 20%
                { double.NaN, double.NaN, 3.14, 3.77, 4.39, 5.01, 5.63, 6.25, 6.87 },
                // conc: 30%
                { double.NaN, 3.35, 2.92, 3.59, 4.2, 4.83, 5.46, 6.09, 6.72 },
                // conc: 40%
                { double.NaN, 3.13, 2.7, 3.4, 4.03, 4.65, 5.28, 5.91, 6.54 },
                // conc: 50%
                { double.NaN, 2.92, 2.47, 3.2, 3.84, 4.47, 5.1, 5.73, 6.36 },
                // conc: 60%
                { 3.07, 2.7, 2.22, 3.0, 3.63, 4.26, 4.89, 5.52, 6.15 },
                // conc: 70%
                { 2.85, 2.47, 2.01, 2.78, 3.41, 4.04, 4.67, 5.3, 5.93 },
                // conc: 80%
                { 2.62, 2.23, 1.82, 2.54, 3.17, 3.8, 4.43, 5.06, 5.69 },
                // conc: 90%
                { 2.37, 2.03, 1.62, 2.33, 2.94, 3.57, 4.2, 4.83, 5.46 },
            };
        }
        ...
        private static double[,] DefaultEthyleneConductivityValues()
        {
            ...
            {
                // conc: 10%
                { double.NaN, double.NaN, 0.462, 0.602, 0.744, 0.885, 1.027, 1.168, 1.31 },
                // conc: 20%
                { double.NaN, double.NaN, 0.337, 0.456, 0.579, 0.702, 0.825, 0.948, 1.071 },
                // conc: 30%
                { double.NaN, 0.369, 0.311, 0.416, 0.527, 0.638, 0.749, 0.86, 0.971 },
                // conc: 40%
                { double.NaN, 0.338, 0.287, 0.382, 0.481, 0.58, 0.679, 0.778, 0.877 },
                // conc: 50%
                { double.NaN, 0.313, 0.268, 0.355, 0.445, 0.535, 0.625, 0.715, 0.805 },
                // conc: 60%
                { 0.324, 0.291, 0.252, 0.327, 0.412, 0.493, 0.574, 0.655, 0.736 },
                // conc: 70%
                { 0.3, 0.271, 0.239, 0.3, 0.377, 0.451, 0.523, 0.595, 0.667 },
                // conc: 80%
                { 0.279, 0.255, 0.227, 0.275, 0.341, 0.402, 0.462, 0.522, 0.582 },
                // conc: 90%
                { 0.261, 0.244, 0.225, 0.262, 0.313, 0.363, 0.412, 0.46, 0.508 },
            };
        }
        ...
        private static double[,] DefaultPropyleneDensityValues()
        {
            ...
            return new double[,]
            {
                ...
                // conc: 40%
                { double.NaN, 1073.6, 1047.0, 1040.0, 1033.0, 1026.0, 1019.0, 1010.0, 1001.0 },
                // conc: 50%
                { double.NaN, 1083.2, 1054.0, 1048.0, 1040.0, 1032.0, 1024.0, 1015.0, 1006.0 },
                // conc: 60%
                { 1074.0, 1081.6, 1062.0, 1055.0, 1046.0, 1037.0, 1028.0, 1018.0, 1007.0 },
                // conc: 70%
                { 1082.2, double.NaN, 1066.0, 1058.0, 1047.0, 1036.0, 1025.0, 1014.0, 1002.0 },
                // conc: 80%
        ...
        private static double[,] DefaultPropyleneSpecificHeatValues()
        {
            ...
            return new double[,]
            {
                ...
                { double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN },
                // conc: 30%
                { double.NaN, double.NaN, 4.05, 4.08, 4.1, 4.13, 4.15, 4.18, 4.2 },
                // conc: 40%
                { double.NaN, 3.58, 3.93, 3.97, 4.0, 4.04, 4.08, 4.12, 4.15 },
                // conc: 50%
                { double.NaN, 3.39, 3.76, 3.83, 3.89, 3.94, 3.99, 4.05, 4.09 },
                // conc: 60%
                { 3.1, 3.17, 3.58, 3.68, 3.75, 3.82, 3.89, 3.96, 4.02 },
                // conc: 70%
                { 2.85, 2.93, 3.38, 3.52, 3.61, 3.69, 3.78, 3.87, 3.94 },
                // conc: 80%
                { 2.58, 2.67, 3.14, 3.33, 3.44, 3.54, 3.66, 3.77, 3.86 },
                // conc: 90%
                { 2.27, 2.37, 2.87, 3.13, 3.28, 3.4, 3.53, 3.66, 3.77 },
            };
        }
        ...
        private static double[,] DefaultPropyleneViscosityValues()
        {
            ...
            return new double[,]
            {
                ...
                // conc: 50%
                { double.NaN, 149.55, 18.05, 8.76, 4.93, 3.14, 2.2, 1.64, 1.31 },
                // conc: 60%
                { 1203.67, 277.95, 31.74, 13.45, 6.97, 4.19, 2.81, 2.06, 1.6 },
                // conc: 70%
                { 2092.2, 429.94, 47.22, 19.57, 9.82, 5.71, 3.7, 2.59, 1.96 },
                // conc: 80%
                { 3299.03, 735.26, 81.47, 30.46, 13.96, 7.52, 4.62, 3.12, 2.27 },
                // conc: 90%
                { 8600.39, 1350.63, 119.31, 43.2, 19.35, 10.23, 6.14, 4.09, 2.93 },
            };
        }
        ...
        private static double[,] DefaultPropyleneConductivityValues()
        {
            ...
            return new double[,]
            {
                ...
                // conc: 60%
                { 0.27, 0.28, 0.325, 0.385, 0.395, 0.407, 0.414, 0.419, 0.42 },
                // conc: 70%
                { 0.242, 0.251, 0.293, 0.343, 0.35, 0.361, 0.367, 0.371, 0.371 },
                // conc: 80%
                { 0.22, 0.227, 0.261, 0.3, 0.307, 0.315, 0.32, 0.323, 0.323 },
                // conc: 90%
                { 0.203, 0.206, 0.234, 0.265, 0.27, 0.275, 0.279, 0.28, 0.28 },
            };
        }
