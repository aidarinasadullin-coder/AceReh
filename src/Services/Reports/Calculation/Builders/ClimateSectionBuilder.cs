...
namespace SnowMeltingCalculator.Services.Reports.Calculation.Builders
{
    ...
    {
        public SectionBuildResult<ClimateSection> Build(ProjectData project, CalculationReportMode mode, ThermalReportDetail? thermalDetail = null, HydraulicsReportDetail? hydraulicsDetail = null)
        {
            ...
            var climateZone = ReportValueFactory.Create(ClimateZoneRules.ZoneText(climate.SelectedZone), "-", ReportValueSource.ProgramDatabase, "ProjectData.ClimateData.SelectedZone");
