...
#pragma warning restore CS0067
        ...
        private static void EnsureApplicationResources()
        {
            ...
            if (resources.MergedDictionaries.Count == 0)
            {
                ...
                resources.MergedDictionaries.Add(new ResourceDictionary
                {
                    Source = new Uri("pack://application:,,,/SnowMeltingCalculator;component/Themes/Tokens.Colors.xaml")
                });
                resources.MergedDictionaries.Add(new ResourceDictionary
                {
                    Source = new Uri("pack://application:,,,/SnowMeltingCalculator;component/Themes/Tokens.Gradients.xaml")
                });
                resources.MergedDictionaries.Add(new ResourceDictionary
                {
        ...
        {
            // Canonical Inter definition from App.xaml (pack URI). Dictionary.xaml
            // no longer carries its own copy (redesign Phase 0, item 8).
            resources["FontFamily.Main"] =
                new FontFamily("pack://application:,,,/SnowMeltingCalculator;component/Assets/Fonts/#Inter");

            // Colors from App.xaml that views and styles depend on. Values are the
            // 2026 brand palette rebinds (redesign Phase 0, plan item 5).
            resources["RehauRed"] = Color.FromRgb(0xE5, 0x00, 0x40);
            resources["RehauTeal"] = Color.FromRgb(0x4F, 0xC7, 0xB5);
            resources["RehauGray"] = Color.FromRgb(0x4E, 0x4E, 0x4E);
            resources["RehauBlack"] = Color.FromRgb(0x00, 0x00, 0x00);
            resources["RehauWhite"] = Color.FromRgb(0xFF, 0xFF, 0xFF);
            resources["RehauRedLight"] = Color.FromRgb(0xF4, 0x55, 0x5E);
            resources["RehauRedDark"] = Color.FromRgb(0xB6, 0x00, 0x34);
            resources["RehauTealLight"] = Color.FromRgb(0x72, 0xD2, 0xC4);
            resources["RehauTealDark"] = Color.FromRgb(0x2F, 0x77, 0x6D);
            ...
            resources["ErrorRed"] = Color.FromRgb(0xE5, 0x00, 0x40);
            resources["SuccessGreen"] = Color.FromRgb(0x3F, 0x9F, 0x91);
            ...
            resources["Gray300"] = Color.FromRgb(0xE4, 0xE4, 0xE4);
            resources["Gray400"] = Color.FromRgb(0xB0, 0xB0, 0xB0);
            resources["Gray500"] = Color.FromRgb(0x81, 0x81, 0x81);
            resources["Gray600"] = Color.FromRgb(0x4E, 0x4E, 0x4E);
            resources["Gray700"] = Color.FromRgb(0x4E, 0x4E, 0x4E);
            resources["Gray800"] = Color.FromRgb(0x4E, 0x4E, 0x4E);
            resources["Gray900"] = Color.FromRgb(0x00, 0x00, 0x00);
            ...
            resources["Color.Border.Processing"] = new SolidColorBrush(Color.FromRgb(0x4F, 0xC7, 0xB5));
