...
public sealed class ThermalAutomationIdSelectorContractTests
{
    ...
    private static readonly (string File, string Id, string ControlType)[] Contract =
    {
        ...
        // «Файл → Инструкция» (2026-09-08): инструкция пользователя
        // (docs/manual/README.html) открывается в браузере
        ...
        // План 2026-09-13 thermal-advice (редакция 2026-09-15, решение владельца:
        // карточка убрана — советы это подписи под полями подачи/шага,
        // Status.Warning.Dark; item-карточки и ThermalAdviceCard не существуют).
        (@"src\Views\Thermal\ThermalView.xaml", "ThermalAdviceSupplyHint", "TextBlock"),
        (@"src\Views\Thermal\ThermalView.xaml", "ThermalAdviceSpacingHint", "TextBlock"),
