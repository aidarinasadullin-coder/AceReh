...
namespace SnowMeltingCalculator.Tests.IntegrationTests.Hydraulics
{
    ...
    /// </remarks>
    [TestFixture]
    public class GlycolAutoRecalculationTests : HydraulicsIntegrationTestBase
    {
        /// <summary>
        /// Историческое расхождение канона (зафиксировано волной 3,
        /// 2026-09-18): PipeSpacing-бэкинг в этом наборе не настраивался.
        /// </summary>
        protected override void ConfigurePipeSpacingBacking()
        {
        }
